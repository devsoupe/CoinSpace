...
import com.perelandrax.coinspace.framework.remote.model.marketcapcoin.mapToDomain
...
class RemoteCoinDataSource(private val okHttpClient: OkHttpClient) : CoinDataSource {
  ...
  override suspend fun getCoinDetail(scope: CoroutineScope, coinId: String): CoinDetail =
    scope.run {
