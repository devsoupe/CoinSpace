...
import com.perelandrax.coincraft.ribs.ico.presentation.tablayout.ActiveAdapter
import com.perelandrax.coincraft.ribs.ico.presentation.tablayout.UpcomingAdapter
...
class IcoBuilder(dependency: ParentComponent) :
  ...
  override fun inflateView(inflater: LayoutInflater, parentViewGroup: ViewGroup): IcoView? {
    return inflater.inflate(R.layout.layout_ico_rib, parentViewGroup, false) as IcoView
  }
